...
public class MainStudentActivity extends ActionBarActivity implements ActionBar.TabListener, Communicator {
	...
	public void goSearch(int kind) {
		//ItemFragment it = (ItemFragment) manager.findFragmentById(R.id.list_item);
		//if(it!=null){
	...
	public void respond(int itemIndex, int kind) {
		//ItemFragment it = (ItemFragment) manager.findFragmentById(R.id.list_item);
		//if(it!=null){
			Intent intent = new Intent(this,InfoWrapperActivity.class);
			intent.putExtra("id", itemIndex);
			intent.putExtra("kind", kind);
			startActivity(intent);
		//}
	}
	...
	public class SectionsPagerAdapter extends FragmentPagerAdapter {
		...
		public Fragment getItem(int position) {
			...
			switch (position) {
				case 0:
					UserProfile iu=new UserProfile();
					iu.setCommunicator(communicator);
					return iu;
				case 1:
					it = new ItemFragment();
					it.setCommunicator(communicator);it.setKind(0);
					return it;
				case 2:
					it=new ItemFragment();
					it.setCommunicator(communicator);it.setKind(1);
					return it;
