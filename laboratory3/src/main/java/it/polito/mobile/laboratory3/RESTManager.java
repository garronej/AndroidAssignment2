...
public class RESTManager {
    ...
    public static String send(String method, String relURI, Map<String, String> urlParameters) throws  IOException{
        ...
        if (urlParameters != null && !urlParameters.isEmpty()) {
            ...
            for (String key : urlParameters.keySet()) {
                ...
                try {
                    ...
                    throw new RuntimeException( "Internal Error RESTManager" + e.getMessage());
                }
        ...
        try {
            ...
            if (con.getResponseCode() == HttpURLConnection.HTTP_OK) {
                ...
                throw new RuntimeException(con.getResponseCode()+": "+ con.getResponseMessage());
